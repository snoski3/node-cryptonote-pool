...
* [Node.js](http://nodejs.org/) v0.10+ ([follow these installation instructions](https://nodejs.org/en/download/package-manager/))
...
* Boost is required for the cryptonote-util module
  ...
  * For CentOS: 'sudo yum install boost-devel'
...
"payments": {
    ...
    "transferFee": 0, //fee to pay for each transaction
...
"blockUnlocker": {
    ...
    "depth": 60,
    "poolFee": 10, //10% pool fee (12% total fee total including donations)
